...
#Date:		Min 31 Mei 2020 11:15:47  WIB

"""
Define VGG models with getBiases() and getFeatures() method
For correct computation of full gradient, do not use inplace operation inside the model
...
class VGG(nn.Module):
    ...
    def getFeatures(self, x):
        """
        Return features at every layer before the ReLU
        """
